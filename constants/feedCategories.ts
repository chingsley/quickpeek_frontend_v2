...
export const CLOSED_QUESTIONS_CATEGORY_KEY = 'closed' as const;
...
export type DrawerMenuCategoryKey =
  ...
  | typeof CLOSED_QUESTIONS_CATEGORY_KEY;
...
export const FEED_CATEGORY_DEFS: FeedCategoryDef[] = [
  ...
  { key: CLOSED_QUESTIONS_CATEGORY_KEY, title: 'My Closed Questions' },
];
